...
GUEST_B_UNIT_1_CHECK_IN_DATE_PLUS_GUEST_1_CHECK_IN : dict = {
...
def test_different_guest_same_unit_booking_different_date(test_db):
    ...
    """
    testCase was having an issue with conflicts today() i.e currentDate which is today used in GUEST_A_UNIT_1 above and 
    today() defined explicitly in JSON below fetch from Pytest freezeTime 2023-05-21
    """

    response = client.post(
        "/api/v1/booking",
        json=GUEST_B_UNIT_1_CHECK_IN_DATE_PLUS_GUEST_1_CHECK_IN
        # json={
        #     'unit_id': '1',  # same unit
